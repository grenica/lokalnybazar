 ...
 */
final class Version20240115183130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT DEFAULT NULL, ADD provider_id INT NOT NULL, ADD available SMALLINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP category_id, DROP provider_id, DROP available');
    }
}
