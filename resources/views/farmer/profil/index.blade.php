     ...
     <div class="card">
       ...
       <div class="card-body">
         ...
         <div class="infouser">
           ...
           <img width="200px" height="200px" src="{{ asset('/rolnicy/'.$farmer->image) }}" alt="">
            {{-- <img src="{{ asset('/images/Gcz_insert.png') }}" /> --}}
             {{-- <img src="{{ url('/images/tlo1.webp') }}" /> --}}
             {{-- public_path('images/image-name.png') --}}
             {{-- Storage::url("app/Gcz_insert.png") --}}
           {{-- <img src="{{ $img }}"/> --}}
           </div>
