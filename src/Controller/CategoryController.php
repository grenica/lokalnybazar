...
class CategoryController extends AbstractController
{
    ...
    {
        $products = $entityManager->getRepository(Category::class)->getProductsByCategory($category);
    ...
    {
        //$categories = $entityManager->getRepository(Category::class)->findAll();//->findBy(['isActive' => true]);
